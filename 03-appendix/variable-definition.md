...
| paramType | string | Yes | Parameter type. See [EnumVariableParameterType](/management-api-docs/#enumvariableparametertype) |
...
| messageContentType | string | Yes | Content type. See [EnumMessageContentType](/management-api-docs/#enummessagecontenttype) |
...
| contextValue | string | Yes | Context value type. See [EnumVariableContextValue](/management-api-docs/#enumvariablecontextvalue) |
...
| scriptLanguage | string | Yes* | - | Script language (required if initWithScript=true). See [EnumScriptType](/management-api-docs/02-api-reference/05-policies/policies/policy-script/) |
...
- [Enum Reference](/management-api-docs/03-appendix/enum-reference/) - Enumeration values used in variables (EnumVariableType, EnumVariableParameterType, etc.)
- [Glossary](/management-api-docs/03-appendix/glossary/) - Terms and definitions
- [API Based Throttling Policy](/management-api-docs/02-api-reference/05-policies/policies/policy-api-based-throttling/) - Uses variables for client identification
- [RLCL API](/management-api-docs/02-api-reference/12-rlcl/) - Uses variables for rate limit control
- [Script Policy](/management-api-docs/02-api-reference/05-policies/policies/policy-script/) - Script language types
