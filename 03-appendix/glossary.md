...
### Variable
A reference to data that can be extracted from requests, responses, or context. See [Variable Definition](/03-appendix/03-appendix/variable-definition/) for complete documentation.
...
### Enum
An enumeration - a fixed set of named values used in API requests and responses. See [Enum Reference](/03-appendix/03-appendix/enum-reference/) for complete list.
...
- [Enum Reference](/03-appendix/03-appendix/enum-reference/) - Complete enumeration reference
- [Variable Definition](/03-appendix/03-appendix/variable-definition/) - Variable documentation
