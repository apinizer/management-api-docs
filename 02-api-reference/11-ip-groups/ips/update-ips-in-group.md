...
Same structure as Add IPs. See [Add IPs to Group](/management-api-docs/02-api-reference/11-ip-groups/ips/add-ips-to-group/) for field descriptions.
...
- [Add IPs to Group](/management-api-docs/02-api-reference/11-ip-groups/ips/add-ips-to-group/) - Add IPs without removing existing ones
- [Delete IPs from Group](/management-api-docs/02-api-reference/11-ip-groups/ips/delete-ips-from-group/) - Remove specific IPs from group
