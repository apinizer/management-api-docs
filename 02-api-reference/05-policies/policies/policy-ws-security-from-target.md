...
### Scenario 1: Decrypt and Verify

Decrypt encrypted content and verify signatures from backend responses.
...
```json
{
  ...
  "policy": {
    "type": "policy-ws-security-from-target",
    "description": "Decrypt and verify WS-Security",
    "active": true,
    "decExists": true,
    "verExists": true,
    "decKeyStoreName": "decryption-keystore",
...
### Scenario 2: Decryption Only

Only decrypt encrypted content without signature verification.
...
```json
{
  ...
  "policy": {
    "type": "policy-ws-security-from-target",
    "description": "Decrypt WS-Security only",
    "active": true,
    "decExists": true,
    "verExists": false,
    "decKeyStoreName": "decryption-keystore",
...
Only verify signatures without decryption.
...
```json
{
  ...
  "policy": {
    "type": "policy-ws-security-from-target",
    "description": "Verify WS-Security signatures only",
    "active": true,
    "decExists": false,
    "verExists": true,
    "decKeyStoreName": null,
