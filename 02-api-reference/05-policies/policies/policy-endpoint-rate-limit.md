...
### Scenario 1: API Key-Based Rate Limit
...
### Scenario 2: IP-Based Rate Limit with Sliding Window

Rate limit by IP address with sliding window.

**Request Body:**
```json
{
  "type": "policy-endpoint-rate-limit",
  "name": "ip-rate-limit-sliding",
  "description": "IP-based rate limit with sliding window",
  "active": true,
  "endpointName": "POST /orders",
  "permittedMessageCount": 50,
  "timeIntervalPeriodLength": 1,
