...
### Scenario 1: Plain Text Password

Add UsernameToken with plain text password.
...
### Scenario 2: Password Digest with Nonce and Created

Add UsernameToken with password digest, nonce, and created timestamp.
