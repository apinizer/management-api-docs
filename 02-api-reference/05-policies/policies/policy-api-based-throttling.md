...
For complete list of context values, see [EnumVariableContextValue](/management-api-docs/02-api-reference/05-policies/policies/03-appendix/variable-definition/).
