...
### Scenario 1: Validate JWT from Authorization Header

Validate JWT token from Authorization header with signature and expiration validation.
...
```json
{
  ...
  "policy": {
    "type": "policy-jose-validation",
    "description": "Validate JWT from Authorization header",
    "active": true,
    "joseTarget": "AUTHORIZATION_HEADER",
    "clientSourcePart": "CLAIMS",
    "clientFieldname": "iss",
...
### Scenario 2: Validate and Decrypt JWE

Validate and decrypt encrypted JWE token.
...
```json
{
  ...
  "policy": {
    "type": "policy-jose-validation",
    "description": "Validate and decrypt JWE",
    "active": true,
    "joseTarget": "BODY",
    "clientSourcePart": "CLAIMS",
    "clientFieldname": "iss",
...
### Scenario 3: Partial Decode with Claims Extraction

Extract specific claims from JWT and place them in a variable.
...
```json
{
  ...
  "policy": {
    "type": "policy-jose-validation",
    "description": "Extract specific claims",
    "active": true,
    "joseTarget": "AUTHORIZATION_HEADER",
    "clientSourcePart": "CLAIMS",
    "clientFieldname": "iss",
