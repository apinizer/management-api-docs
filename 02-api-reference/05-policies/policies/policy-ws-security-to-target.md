...
- [WS Security From Target Policy](/02-api-reference/05-policies/policies/02-api-reference/05-policies/policies/policy-ws-security-from-target/) - Process WS-Security from backend
