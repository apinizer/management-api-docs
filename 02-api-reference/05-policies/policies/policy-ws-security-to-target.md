...
### Scenario 1: Timestamp and UsernameToken

Add Timestamp and UsernameToken to SOAP requests.
...
```json
{
  ...
  "policy": {
    "type": "policy-ws-security-to-target",
    "description": "Add Timestamp and UsernameToken",
    "active": true,
    "mustUnderstand": true,
    "tsTimeToLive": 300,
    "unUsername": "myuser",
    ...
    "unNonce": true,
    "unCreated": true,
    "wsSecurityEntryOrderList": ["TIMESTAMP", "USERNAME_TOKEN"]
  }
}
```

### Scenario 2: Encryption and Signature

Add Encryption and Signature to SOAP requests.
...
```json
{
  ...
  "policy": {
    "type": "policy-ws-security-to-target",
    "description": "Add Encryption and Signature",
    "active": true,
    "mustUnderstand": true,
    "encPartList": [
      {
    ...
    "sigDigAlgorithm": "SHA256",
    "sigKeyStoreName": "signature-keystore",
    "wsSecurityEntryOrderList": ["ENCRYPTION", "SIGNATURE"]
  }
}
```
...
- [WS Security From Target Policy](./policy-ws-security-from-target.md) - Process WS-Security from backend
