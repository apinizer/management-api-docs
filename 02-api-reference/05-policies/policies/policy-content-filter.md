...
### Scenario 1: Block SQL Injection
...
### Scenario 2: Remove Credit Card Numbers

Remove credit card numbers from response.
...
```json
{
  ...
  "policy": {
    "type": "policy-content-filter",
    "description": "Remove credit card numbers",
    "active": true,
    "policyContentFilterDefList": [
      {
        "name": "Credit Card Filter",
...
### Scenario 3: Filter XSS Patterns
...
```json
{
  ...
  "policy": {
    ...
    "policyContentFilterDefList": [
      {
        "name": "XSS Filter",
        "ruleValue": "(?i)(<script|javascript:|onerror=|onclick=|onload=)",
        "headerActive": true,
        "bodyActive": true,
        "paramActive": true,
        "action": "BLOCK",
...
### Scenario 4: Multiple Filter Definitions

Apply multiple filters with different patterns.
...
```json
{
  ...
  "policy": {
    "type": "policy-content-filter",
    "description": "Multiple content filters",
    "active": true,
    "policyContentFilterDefList": [
      {
        "name": "SQL Injection Filter",
      ...
      {
        "name": "XSS Filter",
        "ruleValue": "(?i)(<script|javascript:|onerror=)",
        "headerActive": true,
        "bodyActive": true,
        "paramActive": true,
        "action": "BLOCK",
      ...
      {
        "name": "Path Traversal Filter",
        "ruleValue": "(\\.\\./|\\.\\.\\\\|%2e%2e%2f|%2e%2e%5c)",
        "headerActive": true,
        "bodyActive": true,
        "paramActive": true,
        "action": "BLOCK",
