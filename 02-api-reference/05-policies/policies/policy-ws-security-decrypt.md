...
```json
{
  ...
  "policy": {
    "type": "policy-ws-security-decrypt",
    "description": "Updated: WS-Security decryption with production keystore",
    "active": true,
    "allowCaseInsensitiveId": false,
...
- [WS Security Encrypt Policy](/management-api-docs/02-api-reference/05-policies/policies/policy-ws-security-encrypt/) - Encrypt WS-Security content
