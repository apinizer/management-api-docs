...
### Scenario 1: Decrypt Backend Responses

Decrypt encrypted SOAP responses from backend.
...
```json
{
  ...
  "policy": {
    "type": "policy-ws-security-decrypt",
    "description": "Decrypt backend responses",
    "active": true,
    "allowCaseInsensitiveId": false,
    "decKeyStoreName": "decryption-keystore"
  }
...
Decrypt with case insensitive ID matching for cross-platform compatibility.
...
```json
{
  ...
  "policy": {
    "type": "policy-ws-security-decrypt",
    "description": "Decrypt with case insensitive matching",
    "active": true,
    "allowCaseInsensitiveId": true,
    "decKeyStoreName": "decryption-keystore"
  }
...
- [WS Security Encrypt Policy](./policy-ws-security-encrypt.md) - Encrypt WS-Security content
