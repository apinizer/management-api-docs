...
### Scenario 1: Validate SAML Signature

Validate SAML assertion signature without clearing.
...
```json
{
  ...
  "policy": {
    "type": "policy-saml-validation",
    "description": "Validate SAML signature",
    "active": true,
    "keyStoreId": "saml-keystore-id",
    "allowUnknownSigner": false,
    "clearSaml": false,
...
### Scenario 2: Validate and Clear SAML

Validate SAML assertion and remove it after validation.
...
```json
{
  ...
  "policy": {
    "type": "policy-saml-validation",
    "description": "Validate and clear SAML",
    "active": true,
    "keyStoreId": "saml-keystore-id",
    "allowUnknownSigner": false,
    "clearSaml": true,
...
### Scenario 3: Allow Unknown Signer

Allow SAML validation even if signer is not in KeyStore.
...
```json
{
  ...
  "policy": {
    "type": "policy-saml-validation",
    "description": "Allow unknown signer",
    "active": true,
    "keyStoreId": "saml-keystore-id",
    "allowUnknownSigner": true,
    "clearSaml": false,
    "clearSamlPath": null
  }
}
...
### Scenario 4: Endpoint-Specific SAML Validation

Apply SAML validation to specific endpoint only.
...
```json
{
  ...
  "policy": {
    "type": "policy-saml-validation",
    "description": "SAML validation for specific endpoint",
    "active": true,
    "keyStoreId": "saml-keystore-id",
    "allowUnknownSigner": false,
    "clearSaml": false,
...
- [OIDC Authentication Policy](./policy-oidc.md) - OIDC Authentication
