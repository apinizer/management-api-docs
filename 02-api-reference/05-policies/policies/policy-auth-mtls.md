...
### Scenario 1: Full mTLS Validation

Enable both certificate validation and issuer ACL validation.
...
```json
{
  ...
  "policy": {
    "type": "policy-auth-mtls",
    "description": "Full mTLS validation",
    "active": true,
    "validateCertificate": true,
    "validateACLForIssuer": true
  }
...
### Scenario 2: Certificate Validation Only

Validate certificate but skip issuer ACL check.
...
```json
{
  ...
  "policy": {
    "type": "policy-auth-mtls",
    "description": "Certificate validation only",
    "active": true,
    "validateCertificate": true,
    "validateACLForIssuer": false
  }
...
### Scenario 3: Endpoint-Specific mTLS

Apply mTLS authentication to specific endpoint only.
...
```json
{
  ...
  "policy": {
    "type": "policy-auth-mtls",
    "description": "mTLS for secure endpoint",
    "active": true,
    "validateCertificate": true,
    "validateACLForIssuer": true
  }
