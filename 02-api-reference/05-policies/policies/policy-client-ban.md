...
| Field | Type | Required | Description |
|-------|------|----------|-------------|
| variable | object | Yes | Variable to check. See [Variable Definition](/management-api-docs/02-api-reference/05-policies/policies/03-appendix/variable-definition/) |
