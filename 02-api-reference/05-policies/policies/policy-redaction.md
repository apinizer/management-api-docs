...
### Scenario 1: Delete Sensitive Header

Remove a sensitive header if it exists.
...
```json
{
  ...
  "policy": {
    "type": "policy-redaction",
    "description": "Remove sensitive header",
    "active": true,
    "redactionDefList": [
      {
        "redactionType": "KEY_EXISTENCE",
...
### Scenario 2: Mask Credit Card Number

Mask credit card numbers in JSON body.
...
### Scenario 3: Multiple Redaction Actions

Apply multiple redaction actions in order.
...
```json
{
  ...
  "policy": {
    "type": "policy-redaction",
    "description": "Multiple redaction actions",
    "active": true,
    "redactionDefList": [
      {
        "redactionType": "KEY_EXISTENCE",
