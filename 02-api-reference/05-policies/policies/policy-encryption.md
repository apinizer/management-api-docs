...
| policyEncryptionDefList | array | Yes | - | List of encryption definitions. See [Encryption Definition](/management-api-docs/#encryption-definition) |
...
| sourceVar | object | Yes | - | Source variable to encrypt. See [Variable Object](/management-api-docs/#variable-object) |
| targetVar | object | Yes | - | Target variable for encrypted data. See [Variable Object](/management-api-docs/#variable-object) |
| cipherAlgorithm | string | Yes | - | Cipher algorithm. See [EnumCipherAlgorithm](/management-api-docs/#enumcipheralgorithm) |
...
| ivEncodingType | string | No | null | IV encoding type (if createIV=true). See [EnumEncodingType](/management-api-docs/#enumencodingtype) |
| ivVar | object | No | null | Variable to store IV (if createIV=true) |
| outputEncodingType | string | Yes | - | Output encoding type. See [EnumEncodingType](/management-api-docs/#enumencodingtype) |
