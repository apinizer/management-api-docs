...
Policy condition allows you to specify when this policy should be applied. See [Policy Condition Documentation](../crud/add-policy.md#policy-condition) for detailed information.
