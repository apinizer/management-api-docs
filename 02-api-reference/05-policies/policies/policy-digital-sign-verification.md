...
### Scenario 1: Verify Request Body Signature

Verify signature of request body.
...
### Scenario 2: Verify Multiple Signatures

Verify multiple signatures for different parts of the message.
...
```json
{
  ...
  "policy": {
    "type": "policy-digital-sign-verification",
    "description": "Verify multiple signatures",
    "active": true,
    "policyDigitalSignVerificationDefList": [
      {
        "description": "Verify request body signature",
        ...
        "signatureVar": {
          "type": "HEADER",
          "headerName": "X-Body-Signature"
        },
        "signatureAlgorithm": "SHA256withRSA",
        "enumKeyCertificateType": "KEY",
        "cryptoKeyInfoId": "body-verification-key-id",
        "inputEncodingType": "BASE64"
      },
      {
        "description": "Verify authorization header signature",
        "sourceVar": {
          "type": "HEADER",
        ...
        "enumKeyCertificateType": "CERTIFICATE",
        "certificateId": "auth-verification-cert-id",
        "inputEncodingType": "BASE64"
      }
    ]
  }
...
### Scenario 3: Dynamic Algorithm from Variable

Extract signature algorithm from variable.
...
- [Digital Sign Policy](./policy-digital-sign.md) - Generate digital signatures
