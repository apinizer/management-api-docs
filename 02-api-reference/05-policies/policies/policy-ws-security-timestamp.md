---
layout: default
permalink: /02-api-reference/05-policies/policies/policy-ws-security-timestamp/
---
...
- [WS Security To Target Policy](./policy-ws-security-to-target) - Complete WS-Security configuration
