...
Verify signatures with standard validation.
...
### Scenario 2: Enhanced Validation with Signature Removal

Verify signatures with enhanced validation and remove signature after validation.
...
```json
{
  ...
  "policy": {
    "type": "policy-ws-security-sign-validation",
    "description": "Enhanced validation with signature removal",
    "active": true,
    "enableEnhancedSignatureValidation": true,
    "enableSignatureRemovalForDereferencing": false,
    "allowCaseInsensitiveId": false,
...
- [WS Security Sign Policy](./policy-ws-security-sign.md) - Sign WS-Security content
