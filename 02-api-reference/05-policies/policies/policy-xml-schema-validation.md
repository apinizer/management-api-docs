...
- [JSON Schema Validation Policy](/02-api-reference/05-policies/policies/02-api-reference/05-policies/policies/policy-json-schema-validation/) - Validate JSON messages
