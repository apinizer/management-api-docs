...
### Scenario 1: Validate Against Custom Schema

Validate XML request body against a custom XML Schema.
...
### Scenario 2: Validate Against WSDL Specification

Validate XML against the WSDL specification defined in the API Proxy.
...
```json
{
  ...
  "policy": {
    "type": "policy-xml-schema-validation",
    "description": "Validate against WSDL spec",
    "active": true,
    "pathForBody": "/",
    "validateAgainstSpec": true,
    "schemaDefinitionList": []
...
### Scenario 3: Validate Nested XML Element

Validate a specific nested XML element using XPath.
...
```json
{
  ...
  "policy": {
    "type": "policy-xml-schema-validation",
    "description": "Validate nested data element",
    "active": true,
    "pathForBody": "/root/data",
    "validateAgainstSpec": false,
    "schemaDefinitionList": [
      {
        "schemaNo": 0,
...
### Scenario 4: Multiple Schema Definitions

Validate against multiple XML schemas.
...
```json
{
  ...
  "policy": {
    "type": "policy-xml-schema-validation",
    "description": "Validate with multiple schemas",
    "active": true,
    "pathForBody": "/",
    "validateAgainstSpec": false,
    "schemaDefinitionList": [
      {
        "schemaNo": 0,
        "schemaBody": "<?xml version=\"1.0\" encoding=\"UTF-8\"?><xs:schema xmlns:xs=\"http://www.w3.org/2001/XMLSchema\"><xs:import namespace=\"http://example.com/common\" schemaLocation=\"common.xsd\"/></xs:schema>",
        "systemId": "main.xsd",
        "rootSchema": true
      },
      {
        "schemaNo": 1,
        "schemaBody": "<?xml version=\"1.0\" encoding=\"UTF-8\"?><xs:schema xmlns:xs=\"http://www.w3.org/2001/XMLSchema\" targetNamespace=\"http://example.com/common\"><xs:element name=\"common\" type=\"xs:string\"/></xs:schema>",
        "systemId": "common.xsd",
...
- [JSON Schema Validation Policy](./policy-json-schema-validation.md) - Validate JSON messages
