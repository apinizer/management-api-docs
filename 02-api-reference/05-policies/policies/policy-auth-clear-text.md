...
- [Basic Authentication Policy](/management-api-docs/02-api-reference/05-policies/policies/policy-auth-basic/) - HTTP Basic Authentication
- [Digest Authentication Policy](/management-api-docs/02-api-reference/05-policies/policies/policy-auth-digest/) - HTTP Digest Authentication
