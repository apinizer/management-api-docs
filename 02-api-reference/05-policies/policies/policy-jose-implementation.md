...
| joseTarget | string | Yes | BODY | JOSE target location. See [EnumJoseImplementationSignedTarget](/management-api-docs/#enumjoseimplementationsignedtarget) |
...
| expirationTimeUnit | string | No* | null | Expiration time unit (required if addExpirationTime=true). See [EnumTimeUnit](/management-api-docs/#enumtimeunit) |
| additionalClaimMap | object | No | {} | Map of additional claims. See [MapValue](/management-api-docs/#mapvalue) |
...
| encryptionMethod | string | No* | null | Encryption method (required if encrypt=true). See [EnumJwkEncryptionMethod](/management-api-docs/#enumjwkencryptionmethod) |
| encodedClaimsTargetForDataManipulation | string | No | BODY | Target for encoded claims data manipulation. See [EnumJoseTarget](/management-api-docs/#enumjosetarget) |
| decodedClaimsTargetVariableForDataManipulation | object | No* | null | Variable for encoded claims target (required if encodedClaimsTargetForDataManipulation=CHOOSE_FROM_VARIABLE). See [VariableDTO](/management-api-docs/#variabledto) |
...
- [JOSE Validation Policy](/management-api-docs/02-api-reference/05-policies/policies/policy-jose-validation/) - Validate JOSE tokens
