...
| joseTarget | string | Yes | BODY | JOSE target location. See [EnumJoseImplementationSignedTarget](../../...md#enumjoseimplementationsignedtarget) |
...
| expirationTimeUnit | string | No* | null | Expiration time unit (required if addExpirationTime=true). See [EnumTimeUnit](../../...md#enumtimeunit) |
| additionalClaimMap | object | No | {} | Map of additional claims. See [MapValue](../../...md#mapvalue) |
...
| encryptionMethod | string | No* | null | Encryption method (required if encrypt=true). See [EnumJwkEncryptionMethod](../../...md#enumjwkencryptionmethod) |
| encodedClaimsTargetForDataManipulation | string | No | BODY | Target for encoded claims data manipulation. See [EnumJoseTarget](../../...md#enumjosetarget) |
| decodedClaimsTargetVariableForDataManipulation | object | No* | null | Variable for encoded claims target (required if encodedClaimsTargetForDataManipulation=CHOOSE_FROM_VARIABLE). See [VariableDTO](../../...md#variabledto) |
...
- [JOSE Validation Policy](policy-jose-validation.md) - Validate JOSE tokens
