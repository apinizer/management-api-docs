...
### Scenario 1: Generate Signed JWT
...
```json
{
  ...
  "policy": {
    "type": "policy-jose-implementation",
    "description": "Generate signed JWT",
    "active": true,
    "joseTarget": "AUTHORIZATION_HEADER",
    "addIssueTime": true,
    "addJWTID": true,
...
### Scenario 2: Generate Signed and Encrypted JWE

Generate a signed and encrypted JWE token.
...
```json
{
  ...
  "policy": {
    "type": "policy-jose-implementation",
    "description": "Generate signed and encrypted JWE",
    "active": true,
    "joseTarget": "BODY",
    "addIssueTime": true,
    "addJWTID": true,
...
### Scenario 3: Generate Token with Custom Claims

Generate a JWT token with custom claims from request data.
...
```json
{
  ...
  "policy": {
    "type": "policy-jose-implementation",
    "description": "Generate JWT with custom claims",
    "active": true,
    "joseTarget": "BODY",
    "addIssueTime": true,
    "addJWTID": true,
