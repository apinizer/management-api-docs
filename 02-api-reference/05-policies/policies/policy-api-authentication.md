...
- [Basic Authentication Policy](/management-api-docs/02-api-reference/05-policies/policies/policy-auth-basic/) - Authenticate incoming requests with Basic Auth
- [Digest Authentication Policy](/management-api-docs/02-api-reference/05-policies/policies/policy-auth-digest/) - Authenticate incoming requests with Digest Auth
