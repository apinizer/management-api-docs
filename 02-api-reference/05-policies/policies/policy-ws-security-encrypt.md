...
### Scenario 1: Encrypt Body Content

Encrypt SOAP body content only.
...
```json
{
  ...
  "policy": {
    "type": "policy-ws-security-encrypt",
    "description": "Encrypt body content",
    "active": true,
    "mustUnderstand": true,
    "encPartList": [
      {
...
### Scenario 2: Encrypt Entire Element

Encrypt entire SOAP element.
...
```json
{
  ...
  "policy": {
    "type": "policy-ws-security-encrypt",
    "description": "Encrypt entire element",
    "active": true,
    "mustUnderstand": true,
    "encPartList": [
      {
