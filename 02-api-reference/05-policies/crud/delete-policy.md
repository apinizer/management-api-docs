---
layout: default
permalink: /02-api-reference/05-policies/crud/delete-policy/
---
...
- [Deploy API Proxy](/02-api-reference/05-policies/crud/02-api-reference/04-api-proxies/deployment/deploy/) - Deploy API Proxy after changes
