...
- [Remove API Proxy from Group](/management-api-docs/02-api-reference/09-api-proxy-groups/api-proxies/remove-api-proxy-from-group/) - Remove an API Proxy from group
