---
layout: default
permalink: /02-api-reference/09-api-proxy-groups/crud/create-api-proxy-group/
---
...
| clientRoute | object | Yes | - | Client route configuration. See [Client Route Object](/management-api-docs/#client-route-object) |
...
| methodList | array[string] | No | null | List of HTTP methods to match. See [EnumHttpRequestMethod](/management-api-docs/#enumhttprequestmethod) |
| hostList | array[string] | No | null | List of host names to match |
| headerList | array[object] | No | null | List of headers to match. See [Header Object](/management-api-docs/#header-object) |
...
- [Update API Proxy Group](/management-api-docs/02-api-reference/09-api-proxy-groups/crud/update-api-proxy-group/) - Update an API Proxy Group
- [Add API Proxy to Group](/management-api-docs/02-api-reference/09-api-proxy-groups/api-proxies/add-api-proxy-to-group/) - Add API Proxies to group
