...
Same structure as Create API Proxy Group. See [Create API Proxy Group](/02-api-reference/09-api-proxy-groups/crud/02-api-reference/09-api-proxy-groups/crud/create-api-proxy-group/) for field descriptions.
