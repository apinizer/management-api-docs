...
- [Authentication Guide](/02-api-reference/10-environment-variables/01-getting-started/authentication/) - How to obtain and use API tokens
- [Error Handling](/02-api-reference/10-environment-variables/01-getting-started/error-handling/) - Error response formats
