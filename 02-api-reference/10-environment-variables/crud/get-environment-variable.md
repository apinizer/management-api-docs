...
Same as List Environment Variables. See [List Environment Variables](/02-api-reference/10-environment-variables/crud/02-api-reference/10-environment-variables/crud/list-environment-variables/) for field descriptions.
...
- [List Environment Variables](/02-api-reference/10-environment-variables/crud/02-api-reference/10-environment-variables/crud/list-environment-variables/) - List all environment variables
