...
See [Variable Definition](/02-api-reference/12-rlcl/crud/03-appendix/variable-definition/) for complete variable documentation.

| Field | Type | Required | Description |
|-------|------|----------|-------------|
| name | string | Yes | Variable name (e.g., "client.ip", "request.header.X-User-ID") |
| type | string | Yes | Variable type. See [Variable Types](/02-api-reference/12-rlcl/crud/03-appendix/variable-definition/) |
| headerName | string | No* | Header name (required if type=HEADER) |
| paramType | string | No* | Parameter type (required if type=PARAMETER). See [EnumVariableParameterType](/02-api-reference/12-rlcl/crud/03-appendix/variable-definition/) |
| paramName | string | No* | Parameter name (required if type=PARAMETER) |
| paramPath | string | No* | Parameter path template (required if type=PARAMETER and paramType=PATH) |
| messageContentType | string | No* | Message content type (required if type=BODY). See [EnumMessageContentType](/02-api-reference/12-rlcl/crud/03-appendix/variable-definition/) |
...
| contextValue | string | No* | Context value (required if type=CONTEXT_VALUES). See [EnumVariableContextValue](/02-api-reference/12-rlcl/crud/03-appendix/variable-definition/) |
