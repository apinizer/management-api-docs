...
Same structure as Add Condition. See [Add Condition](/02-api-reference/12-rlcl/condition/02-api-reference/12-rlcl/condition/add-condition/) for field descriptions.
...
Same as Add Condition. See [Add Condition](/02-api-reference/12-rlcl/condition/02-api-reference/12-rlcl/condition/add-condition/) for response format.
...
- [Add Condition](/02-api-reference/12-rlcl/condition/02-api-reference/12-rlcl/condition/add-condition/) - Add condition to RLCL
