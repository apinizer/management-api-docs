...
- [Upload MMDB File](/02-api-reference/13-geolocation/02-api-reference/13-geolocation/upload-mmdb-file/) - Upload MaxMind GeoIP2 database file
- [Enable Geolocation](/02-api-reference/13-geolocation/02-api-reference/13-geolocation/enable-geolocation/) - Enable geolocation functionality
- [Disable Geolocation](/02-api-reference/13-geolocation/02-api-reference/13-geolocation/disable-geolocation/) - Disable geolocation functionality
