...
### Scenario 1: Basic Elasticsearch Connection

Simple connection to local Elasticsearch without authentication.
...
```json
{
  ...
  "description": "Local Elasticsearch connection",
  "deployToWorker": true,
  "enabled": true,
  "administrate": true,
  "elasticHostList": [
...
### Scenario 2: Production Elasticsearch with Authentication and Encryption

Production-ready connection with authentication and PKCS12 encryption.
...
```json
{
  ...
  "description": "Production Elasticsearch with auth and encryption",
  "deployToWorker": true,
  "enabled": true,
  "administrate": true,
  "elasticHostList": [
  ...
  "authenticate": true,
  "elasticUsername": "elastic",
  "elasticPassword": "secure-password",
  "encryptCommunication": true,
  "encryptCommunicationType": "CA_CERTIFICATE_IN_PKCS_12",
  "caCertInPkcs12File": "<base64-encoded-pkcs12>",
  "caCertInPkcs12FileContentType": "application/x-pkcs12",
  "caTruststoreFilePass": "keystore-password",
  "disableHostnameVerification": false,
  "type": "READ_WRITE"
...
### Scenario 3: Read-Only Connection

Read-only connection for querying only.

**Request Body:**
```json
{
  "_class": "elasticsearch",
  "name": "readonly-elasticsearch",
  "description": "Read-only Elasticsearch connection",
  "deployToWorker": true,
  "enabled": true,
  "administrate": false,
  "elasticHostList": [
  ...
  "authenticate": true,
  "elasticUsername": "readonly-user",
  "elasticPassword": "readonly-password",
  "encryptCommunication": true,
  "encryptCommunicationType": "CA_IN_PEM_FILE",
  "caInPemFile": "<base64-encoded-pem>",
  "caInPemFileContentType": "application/x-pem-file",
  "type": "READ"
}
```
