...
### Scenario 1: SNMP v1 Trap

Basic SNMP v1 trap with community name.
...
```json
{
  "_class": "snmp",
  "name": "snmp-v3-secure",
  "description": "SNMP v3 with auth and privacy",
  "deployToWorker": true,
  "enabled": true,
  "version": "V3",
  "connectionString": "udp:192.168.1.2/162",
