...
### Scenario 1: Basic PostgreSQL Connection

Standard PostgreSQL connection with default pool settings.
...
### Scenario 2: High-Performance Connection

Connection with increased pool size for high-throughput scenarios.
