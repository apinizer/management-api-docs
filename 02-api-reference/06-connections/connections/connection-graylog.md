...
### Scenario 1: Basic TCP Connection

Standard TCP connection without encryption or compression.
...
```json
{
  "_class": "graylog",
  "name": "basic-graylog",
  "description": "Basic Graylog TCP connection",
  "deployToWorker": true,
  "enabled": true,
  "hostname": "graylog.example.com",
  "port": 12201,
...
### Scenario 2: High-Performance UDP Connection

UDP connection with GZIP compression for high-throughput logging.
...
```json
{
  "_class": "graylog",
  "name": "udp-graylog",
  "description": "High-performance UDP connection",
  "deployToWorker": true,
  "enabled": true,
  "hostname": "graylog.example.com",
  "port": 12201,
  ...
  "gelfMessageLevel": "INFO",
  "queueSize": 2048,
  "maxInflightSends": 2048
}
```

### Scenario 3: Secure TLS Connection

TCP connection with TLS encryption and certificate verification.
...
```json
{
  ...
  "queueSize": 1024,
  "connectTimeout": 15000,
  "tlsTrustCertChainFile": "LS0tLS1CRUdJTi...",
  "tlsTrustCertChainFileName": "graylog-ca.crt"
}
```
