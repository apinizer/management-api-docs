...
### Scenario 1: Simple POST Webhook

Basic POST webhook for sending notifications.
...
```json
{
  "_class": "webhook",
  "name": "simple-webhook",
  "description": "Simple POST webhook",
  "deployToWorker": true,
  "enabled": true,
  "httpMethod": "POST",
  "fullUrl": "https://webhook.example.com/api/notify",
...
### Scenario 2: Authenticated Webhook
...
```json
{
  ...
  "enabled": true,
  "httpMethod": "POST",
  "fullUrl": "https://api.example.com/webhook",
  "headerList": [
    {
      "name": "Content-Type",
      "value": "application/json"
...
### Scenario 3: High-Performance Webhook

Webhook with increased connection pool for high throughput.

**Request Body:**
```json
{
  "_class": "webhook",
  "name": "high-performance-webhook",
  "description": "High-performance webhook with increased pool",
  "deployToWorker": true,
  "enabled": true,
  "httpMethod": "POST",
  "fullUrl": "https://api.example.com/webhook",
  ...
  "timeout": 5,
  "connectionPoolMaxConnectionPerHost": 100,
  "connectionPoolMaxConnectionTotal": 200
}
```
