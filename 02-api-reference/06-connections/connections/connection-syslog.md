...
| Field | Type | Required | Default | Description |
|-------|------|----------|---------|-------------|
| syslogProtocolType | string | No | TCP | Protocol type. See [EnumSyslogProtocolType](/management-api-docs/#enumsyslogprotocoltype) |
...
| syslogMessageFormat | string | No | RFC_3164 | Message format. See [MessageFormat](/management-api-docs/#messageformat) |
| syslogAppName | string | No | Apinizer | Application name to include in syslog messages |
| syslogFacility | string | No | AUDIT | Syslog facility. See [Facility](/management-api-docs/#facility) |
| syslogSeverity | string | No | INFORMATIONAL | Syslog severity level. See [Severity](/management-api-docs/#severity) |
