...
For detailed documentation on specific connection types, see [Connection Types](/management-api-docs/02-api-reference/06-connections/connections/).
...
- [Connection Types](/management-api-docs/02-api-reference/06-connections/connections/) - Detailed documentation for each connection type
