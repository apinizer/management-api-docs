...
The request body structure is identical to [Create Connection](/02-api-reference/06-connections/crud/02-api-reference/06-connections/crud/create-connection/). See that documentation for complete field descriptions.
