---
layout: default
permalink: /02-api-reference/06-connections/crud/get-connection/
---
...
- [List Connections](/02-api-reference/06-connections/crud/02-api-reference/06-connections/crud/list-connections/) - List all connections (secrets masked)
