...
- **Get Single Connection**: Use [Get Connection](./get-connection) to retrieve full connection details including secrets
...
- [Get Connection](./get-connection) - Get detailed connection information
