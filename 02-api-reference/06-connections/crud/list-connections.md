...
- **Get Single Connection**: Use [Get Connection](/02-api-reference/06-connections/crud/02-api-reference/06-connections/crud/get-connection/) to retrieve full connection details including secrets
...
- [Get Connection](/02-api-reference/06-connections/crud/02-api-reference/06-connections/crud/get-connection/) - Get detailed connection information
