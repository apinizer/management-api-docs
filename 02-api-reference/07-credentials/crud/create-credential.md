...
### Scenario 1: Create API User Credential

Create a credential for an API user with basic access.
...
### Scenario 2: Create Developer Credential with Multiple Roles

Create a credential for a developer with multiple roles.
...
```json
{
  ...
  "description": "Developer credential",
  "username": "developer",
  "password": "SecurePassword123!",
  "roleNameList": [
    "API_USER",
...
### Scenario 3: Create Restricted Credential

Create a credential with IP restrictions for security.
