...
- [Get Granted Access List](/02-api-reference/07-credentials/crud/02-api-reference/07-credentials/access/get-granted-access-list/) - Get access list for credential
