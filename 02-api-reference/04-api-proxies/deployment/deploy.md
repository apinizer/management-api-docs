---
layout: default
permalink: /02-api-reference/04-api-proxies/deployment/deploy/
---
...
- [Undeploy API Proxy](/02-api-reference/04-api-proxies/deployment/02-api-reference/04-api-proxies/deployment/undeploy/) - Undeploy API proxy from environment
- [List API Proxies](/02-api-reference/04-api-proxies/deployment/02-api-reference/04-api-proxies/crud/list-api-proxies/) - List all API proxies
