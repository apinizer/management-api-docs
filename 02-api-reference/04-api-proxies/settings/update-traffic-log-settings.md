...
Connectors must be created and configured before enabling them. See [Connections API](/management-api-docs/02-api-reference/06-connections/) for connector management.
...
- **Connectors**: Connectors must be created before enabling (see [Connections API](/management-api-docs/02-api-reference/06-connections/))
...
- [Connections API](/management-api-docs/02-api-reference/06-connections/) - Manage connectors for log export
