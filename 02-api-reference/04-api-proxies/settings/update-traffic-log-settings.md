...
### Scenario 1: Full Request/Response Logging
...
### Scenario 2: Minimal Logging with Elasticsearch Export

Log only essential data and export to Elasticsearch.
...
### Scenario 3: Multiple Connectors

Export logs to multiple destinations.
