...
Connectors must be created and configured before enabling them. See [Connections API](/02-api-reference/04-api-proxies/settings/02-api-reference/06-connections/) for connector management.
...
- **Connectors**: Connectors must be created before enabling (see [Connections API](/02-api-reference/04-api-proxies/settings/02-api-reference/06-connections/))
...
- [Connections API](/02-api-reference/04-api-proxies/settings/02-api-reference/06-connections/) - Manage connectors for log export
