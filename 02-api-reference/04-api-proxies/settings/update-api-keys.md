---
layout: default
permalink: /02-api-reference/04-api-proxies/settings/update-api-keys/
---
...
- [Get API Proxy](/management-api-docs/02-api-reference/04-api-proxies/crud/get-api-proxy/) - Get API proxy details (includes current keys)
- [Update Metadata](/management-api-docs/02-api-reference/04-api-proxies/settings/update-metadata/) - Update API proxy metadata
- [Create API Proxy](/management-api-docs/02-api-reference/04-api-proxies/crud/create-api-proxy-from-url/) - Create new API proxy
