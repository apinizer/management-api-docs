...
- [Update Circuit Breaker Settings](/02-api-reference/04-api-proxies/settings/02-api-reference/04-api-proxies/settings/update-circuit-breaker-settings/) - Update circuit breaker settings
- [Update Routing Addresses](/02-api-reference/04-api-proxies/settings/02-api-reference/04-api-proxies/settings/update-routing-addresses/) - Update routing addresses
