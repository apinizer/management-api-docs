...
### Scenario 1: Create REST API Proxy from OpenAPI

Create a REST API proxy from an OpenAPI 3.0 specification URL.

**Request Body:**
```json
{
  "apiProxyName": "users-api",
  "apiProxyDescription": "Users Management API",
  "apiProxyCreationType": "OPEN_API",
  "specUrl": "https://api.example.com/openapi.json",
  "clientRoute": {
    "relativePathList": ["/api/users"]
  },
  "deploy": false,
  "reParse": false
}
...
### Scenario 2: Create SOAP API Proxy from WSDL

Create a SOAP API proxy from a WSDL URL.
...
### Scenario 3: Create Reverse Proxy

Create a reverse proxy without a specification file.

**Request Body:**
```json
{
  "apiProxyName": "reverse-proxy",
  "apiProxyDescription": "Reverse Proxy",
...
### Scenario 4: Create and Deploy

Create an API proxy and automatically deploy it to production.

**Request Body:**
```json
{
  "apiProxyName": "production-api",
  "apiProxyDescription": "Production API",
  "apiProxyCreationType": "OPEN_API",
  "specUrl": "https://api.example.com/openapi.json",
  "deploy": true,
  "deployTargetEnvironmentNameList": ["production"],
