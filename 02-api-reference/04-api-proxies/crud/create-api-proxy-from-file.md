...
### Scenario 1: Create API Proxy with Routing Configuration

Create an API proxy with multiple backend addresses and load balancing.

**Metadata JSON:**
```json
{
  "apiProxyName": "load-balanced-api",
  "apiProxyDescription": "Load balanced API",
  "apiProxyCreationType": "OPEN_API",
  "clientRoute": {
    "relativePathList": ["/api/v1"]
  },
...
### Scenario 2: Create API Proxy with Maintenance Mode

Create an API proxy with maintenance mode enabled.

**Metadata JSON:**
```json
{
  "apiProxyName": "maintenance-api",
  "apiProxyDescription": "API in maintenance",
  "apiProxyCreationType": "OPEN_API",
  "clientRoute": {
