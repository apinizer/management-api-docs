---
layout: default
permalink: /02-api-reference/04-api-proxies/crud/update-api-proxy/
---
...
The request body structure is identical to [Create API Proxy from URL](/management-api-docs/02-api-reference/04-api-proxies/crud/create-api-proxy-from-url/) or [Create API Proxy from File](/management-api-docs/02-api-reference/04-api-proxies/crud/create-api-proxy-from-file/), with the following differences:
...
- [Create API Proxy from File](/management-api-docs/02-api-reference/04-api-proxies/crud/create-api-proxy-from-file/) - Create new API proxy from file
