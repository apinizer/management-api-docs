...
The request body structure is identical to [Create API Proxy from URL](/02-api-reference/04-api-proxies/crud/02-api-reference/04-api-proxies/crud/create-api-proxy-from-url/) or [Create API Proxy from File](/02-api-reference/04-api-proxies/crud/02-api-reference/04-api-proxies/crud/create-api-proxy-from-file/), with the following differences:
