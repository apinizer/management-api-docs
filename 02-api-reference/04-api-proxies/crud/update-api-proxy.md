...
The request body structure is identical to [Create API Proxy from URL](./create-api-proxy-from-url) or [Create API Proxy from File](./create-api-proxy-from-file), with the following differences:
...
- [Create API Proxy from URL](./create-api-proxy-from-url) - Create new API proxy from URL
- [Create API Proxy from File](./create-api-proxy-from-file) - Create new API proxy from file
