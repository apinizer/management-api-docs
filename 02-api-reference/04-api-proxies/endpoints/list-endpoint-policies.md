...
**Note:** Policy objects contain only basic information. For full policy details, use the [Policies API](/management-api-docs/02-api-reference/05-policies/).
...
- **Policy Details**: Policy objects contain basic information only. For full policy configuration, use the [Policies API](/management-api-docs/02-api-reference/05-policies/)
...
- [Policies API](/management-api-docs/02-api-reference/05-policies/) - Policy management API
