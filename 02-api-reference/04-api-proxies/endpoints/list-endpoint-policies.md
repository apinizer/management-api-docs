...
Retrieves all policies (request, response, and error) for a specific endpoint (API method). This endpoint returns the same information as [Get Endpoint](/02-api-reference/04-api-proxies/endpoints/02-api-reference/04-api-proxies/endpoints/get-endpoint/) but includes policy details.
...
**Note:** Policy objects contain only basic information. For full policy details, use the [Policies API](/02-api-reference/04-api-proxies/endpoints/02-api-reference/05-policies/).
...
- **Policy Details**: Policy objects contain basic information only. For full policy configuration, use the [Policies API](/02-api-reference/04-api-proxies/endpoints/02-api-reference/05-policies/)
...
- [Get Endpoint](/02-api-reference/04-api-proxies/endpoints/02-api-reference/04-api-proxies/endpoints/get-endpoint/) - Get endpoint details (without policies)
- [Policies API](/02-api-reference/04-api-proxies/endpoints/02-api-reference/05-policies/) - Policy management API
