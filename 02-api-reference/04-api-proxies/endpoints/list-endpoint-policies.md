...
Retrieves all policies (request, response, and error) for a specific endpoint (API method). This endpoint returns the same information as [Get Endpoint](./get-endpoint.md) but includes policy details.
...
**Note:** Policy objects contain only basic information. For full policy details, use the [Policies API](../../05-policies/index.md).
...
- **Policy Details**: Policy objects contain basic information only. For full policy configuration, use the [Policies API](../../05-policies/index.md)
...
- [Policies API](../../05-policies/index.md) - Policy management API
