...
- **Admin Only**: This endpoint requires admin role. Regular users should use [Get Environments by Project](/management-api-docs/02-api-reference/03-environments/get-environments-by-project/)
